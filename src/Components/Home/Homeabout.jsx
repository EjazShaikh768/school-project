                ...
                <div className="container">
                    <div className="row px-4 justify-content-between marginTop">
                        ...
                        <div className="col-sm-12 col-md-4 col-lg-4 ">
                            <div className="row  box mt-4 profileCard" data-aos="fade-down-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000"  >
                            ...
                            <div className="row box mt-4 profileCard" data-aos="fade-down" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                                <div className="col-sm-6 ">
                            ...
                            <div className="row box mt-4 profileCard" data-aos="fade-down" data-aos-easing="ease-out-cubic" data-aos-duration="3000">
                                <div className="col-sm-6 ">
                                    <img src={persident} alt="" className="img-fluid" />
                                </div>
                                <div className="col-sm-6 ">
